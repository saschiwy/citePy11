...
"""
    ...
    def add_module(self, content, module_name):
        return content + f'PYBIND11_MODULE({module_name}, m) {{\n'
    ...
    def add_enums(self, content, enums, namespace_prefix):
        for enum in enums:
            ...
            content += 'py::enum_<' + full_name + '> ' + '(m, "' + name + '"' + self.__add_description__(enum.doxygen) + ')\n'
    ...
    def add_classes(self, content, classes, namespace_prefix):
        for clas in classes:
            ...
            content += 'py::class_<' + full_name + '> ' + '(m, "' + name + '"' + self.__add_description__(clas.class_decl.doxygen) + ')\n'
